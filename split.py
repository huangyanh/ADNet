...
if __name__ == '__main__':
    ...
    parser.add_argument('--image-dir', type=str, default='F:\\Datasets\\segmentation\\Raw', help='image path dir')
    parser.add_argument('--txt-dir', type=str, default='F:\\Datasets\\segmentation\\Raw_Label', help='txt path dir')
    parser.add_argument('--save-dir', default='F:\\Datasets\\segmentation\\split', type=str, help='save dir')
